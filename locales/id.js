export const id = {
  ...
  terms: {
    ...
    sec7Items: [
      ...
      "Terorisme", 
      "Eksploitasi anak", 
      "Aktivitas yang terkena sanksi",
      "AetherVault menyediakan layanan Bukti Keberadaan (Proof of Existence) dan stempel waktu kriptografis. Layanan ini bukan pengganti pendaftaran Hak Kekayaan Intelektual (HAKI) resmi pada otoritas negara.",
      "Pengguna dilarang keras memanfaatkan penyimpanan terdesentralisasi AetherVault untuk mengenkripsi atau mendistribusikan materi ilegal, terorisme, atau pornografi. Sebagai penyedia layanan Zero-Knowledge, pengembang dibebaskan dari segala pertanggungjawaban hukum atas data tersandi yang dibuat oleh pengguna."
    ],
