export const id = {
  ...
  dashboard: {
    ...
    adminTitle: "Kontrol Admin Terbatas",
    adminSubtitle: "Panel manajemen khusus Owner (Diakses via URL /admin).",
    ...
    adminMainEmergency: "Darurat Kontrak Utama",
    adminPauseMain: "Pause Main",
    adminUnpauseMain: "Unpause Main",
    adminStakeEmergency: "Darurat Kontrak Staking",
    adminPauseStake: "Pause Stake",
    adminUnpauseStake: "Unpause Stake",
    adminChangeTreasury: "Ganti Alamat Treasury",
    adminTreasuryPlaceholder: "0x... (Alamat Wallet Treasury Baru)",
    adminUpdateTreasuryBtn: "Update Treasury",
    adminVestingTitle: "Brankas Gaji Developer (Vesting)",
    adminVestingDesc: "Cairkan AETH atau ganti alamat dompet penerima (Timelock 48 Jam).",
