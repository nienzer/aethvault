export const en = {
  ...
  dashboard: {
    ...
    secPara1: "Title, message, and attachments are encrypted (ECIES/secp256k1) directly in your browser before leaving the device. The decryption key is derived from your wallet's own EIP-712 signature and is never sent anywhere. Only ciphertext is stored on the blockchain and Arweave.",
    secPara2: "Arweave is permanent — storage fees are paid separately from your wallet. Legacy capsule titles & messages are encrypted specifically for the heir. Once sealed, you yourself will not be able to read them again — only the heir can, after the inactivity requirement is met. The heir must have opened AetherVault once and registered their encryption key in the Settings tab.",
    secPara3: "What is NOT encrypted (public): owner address, heir address, capsule creation/opening time, and selected tier.",
    secPara4: "The encryption key is bound to the network (Polygon Amoy Testnet). Do not use AetherVault on another network.",
