export const en = {
  ...
  dashboard: {
    ...
    adminTitle: "Restricted Admin Control",
    adminSubtitle: "Owner exclusive management panel (Accessed via /admin).",
    ...
    adminMainEmergency: "Main Contract Emergency",
    adminPauseMain: "Pause Main",
    adminUnpauseMain: "Unpause Main",
    adminStakeEmergency: "Staking Contract Emergency",
    ...
    adminVestingTitle: "Developer Salary Vault (Vesting)",
    adminVestingDesc: "Claim AETH or change beneficiary wallet (48-Hour Timelock).",
