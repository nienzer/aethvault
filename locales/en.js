export const en = {
  ...
  hero: {
    ...
    desc: "Secure messages, memories, contracts, certificates, and intellectual property on the BSC Testnet blockchain forever using military-grade ECIES cryptography.",
  ...
  landing: {
    liveData: {
      ...
      blockLabel: "Block:",
      proofsLabel: "Proofs:",
      stakersLabel: "Guardians:",
      connecting: "Connecting to BSC Testnet...",
      synced: "Verified On-Chain & Synced",
      rpcError: "RPC Connection Error",
      syncing: "Syncing..."
    },
    animation: {
      archDiagram: "Architecture Diagram",
      encCapsule: "Encrypted Capsule",
      polyNetwork: "BSC Testnet",
    ...
    howItWorks: {
      ...
      step3Desc: "A smart contract records your ciphertext, hash, and unlock conditions immutably on the BSC Testnet network.",
  ...
  hallOfProof: {
    ...
    title: "Hall of Proof™",
    desc: "The World's Permanent Registry for Verified Intellectual Property. Explore authentic digital assets secured directly on the BSC Testnet blockchain.",
    ...
    securedOnChain: "SECURED ON-CHAIN",
    decentralizedRegistry: "Decentralized Vault Registry",
    certAuthenticity: "CERTIFICATE OF AUTHENTICITY",
    certProtocol: "AETHER PROOF COPYRIGHT REGISTRATION PROTOCOL",
    assetTitle: "ASSET TITLE / TYPE",
    certNo: "CERTIFICATE NO.",
    ownerAddress: "OWNER ADDRESS",
    legalCreator: "LEGAL CREATOR",
    vaultStatus: "VAULT STATUS",
    authenticated: "● Authenticated & Verified",
    regDate: "REGISTRATION DATE",
    assetDesc: "ASSET DESCRIPTION",
    defaultAssetDesc: "This legal artifact asset is permanently secured via end-to-end cryptographic primitives and timestamped on-chain. Molecular ownership records are absolute, immutable, and non-fungible.",
    tokenIdLabel: "TOKEN ID",
    networkProt: "NETWORK PROT.",
    smartContract: "SMART CONTRACT",
    authenticatedBadge: "AUTHENTICATED",
    digitalArtifact: "DIGITAL ARTIFACT",
    aetherProofProof: "AETHER PROOF",
    serialReg: "SERIAL REG.",
    autoAuthStatus: "AUTOMATED AUTHENTICITY STATUS",
    verifiableOnChain: "100% VERIFIABLE ON-CHAIN",
    bscVerified: "BSC VERIFIED",
    decentralizedAudit: "DECENTRALIZED AUDIT",
    scanMetadata: "SCAN METADATA CONTRACT",
    footerMotto1: "VERIFIABLE • IMMUTABLE • SECURED FOREVER",
    footerMotto2: "POWERED BY AETHERVAULT PROTOCOL",
    preparingTx: "Preparing transaction...",
    confirmMintMetaMask: "Please confirm Mint transaction in MetaMask...",
    waitingBlockValidation: "Waiting for BSC Testnet block validation...",
    txFailed: "Transaction cancelled or failed: ",
    certNotReady: "Certificate not ready.",
    downloadPngFail: "Failed to download PNG. Please try again.",
    downloadPdfFail: "Failed to download PDF. Please try again.",
    onChainLabel: "On-Chain",
    livePipeline: "Live Pipeline",
    keccakHash: "Keccak256 Hash",
    immutableCert: "Immutable Certificate",
    networkLabel: "Network",
    liveOnChainLabel: "Live On-Chain",
    fetchingRegistry: "Fetching Blockchain Registry...",
    dateLabel: "Date",
    metadataDetails: "Metadata Details",
    step1Config: "STEP 1: CONFIGURATION",
    titleLabel: "Title *",
    titlePlaceholder: "e.g., Core Smart Contract v1",
    creatorPlaceholder: "e.g., Satoshi Nakamoto",
    descLabel: "Description",
    descPlaceholder: "Short description about this proof...",
    targetFile: "Target File",
    clickToBrowse: "Click to Browse or Drop File",
    removeFile: "Remove File",
    mintCost: "Mint Cost",
    burnLabel: "Burn",
    stakingPoolLabel: "Vault Reserve",
    mintIssueProof: "Mint & Issue Proof",
    liveNftPreview: "Live NFT Preview",
    processingTx: "Processing On-Chain Transaction",
    mintSuccessTitle: "Aether Proof Minted Successfully!",
    mintSuccessDesc: "Your digital asset is now permanently secured on the blockchain.",
    viewTransaction: "View Transaction",
    mintAnother: "Mint Another Proof",
    metaMaskNotFound: "MetaMask not found! Please install the MetaMask extension.",
    trustless: "TRUSTLESS • VERIFIED • TIMELESS",
    ownerLabel: "OWNER",
    creatorLabel: "CREATOR",
    statusLabel: "STATUS",
    networkOnlyLabel: "NETWORK",
    contractOnlyLabel: "CONTRACT",
  ...
  globalStats: {
    ...
    tvl: "Vault TVL",
    locked: "Total $AETH",
    stakers: "Total Guardians",
    active: "Active",
    height: "BSC Testnet Height",
    liveSync: "Live Sync",
    targetChain: "Target Chain:",
    activityTitle: "Recent Ecosystem Activity",
    noActivity: "No recent activity found on the network.",
    mintedOnChain: "Minted On-Chain",
    networkStatus: "Network Status",
    optimalSecured: "Optimal & Secured",
    rpcLatency: "RPC Latency"
  },
  stakingUi: {
    title: "SECURITY VAULT",
    subtitle: "Secure the Network • Earn Allocations",
    currentApy: "Current Rate",
    tvl: "Total Locked (TVL)",
    health: "Network Health",
    stakeNew: "Lock AETH",
    amountToStake: "Amount to Lock",
    available: "Available:",
    estRewards: "Estimated Vault Allocations",
    perDay: "Per Day",
    perWeek: "Per Week",
    perMonth: "Per Month",
    btnLocking: "Locking AETH...",
    btnConfirm: "Confirm Lock",
    yourPosition: "Your Position",
    active: "Active",
    totalStaked: "Total Locked",
    portfolioShare: "Portfolio Share:",
    pendingRewards: "Pending Allocations",
    estDaily: "Est. Daily",
    nextReward: "Next Allocation",
    claimReady: "Ready",
    noRewards: "No Allocations to Claim",
    withdraw: "Withdraw",
    howItWorks: "How Vault Locking Works",
    yourAeth: "Your $AETH",
    stakingPool: "Vault Reserve",
    validators: "BSC Validators",
    dailyRewards: "Daily Allocations",
    emptyTitle: "No Active Vault",
    emptyDesc: "Lock AETH to secure the protocol and receive network allocations continuously.",
    maxBtn: "MAX",
    maxLimitReached: "Maximum locking limit per wallet is 50,000 AETH.",
    maxApy: "MAX RATE",
    tierGold: "Tier Gold",
    connectWallet: "Connect Wallet",
    claimPrefix: "Claim",
    activeDeposits: "ACTIVE LOCKS",
    lockedStatus: "Locked",
    unlockedStatus: "Unlocked",
    emergencyBtn: "Emergency",
    emergencyTooltip: "Force Withdraw: Forfeit Allocations!",
    noLock: "No Lock",
    days: "Days"
  },
  vaultsUi: {
    ...
    wrongNetworkWarning: "⚠️ Please switch to BSC Testnet to interact with your vaults.",
  ...
  infrastructure: {
    ...
    interopDesc: "Seamless integration on top of the BSC Testnet blockchain network in real-time.",
  ...
  footer: {
    ...
    mainnetOp: "BSC Testnet Operational"
  },
  whitepaper: {
    ...
    sec4Text: "The protocol operates on a trustless, transparent pipeline:\nUser → Browser (Local Processing) → ECIES Encryption → IPFS / Arweave → BSC Testnet Smart Contract → NFT Certificate → Hall of Proof.",
    ...
    sec13Text: "The AetherVault ecosystem extends beyond secure storage to provide a comprehensive Web3 terminal.\n\n**1. AetherForge (Token Factory)**\nA decentralized, anti-spam custom token factory that allows users to deploy standard utility tokens seamlessly. To maintain the economic health of the network, AetherForge integrates a mandatory AETH fee burn mechanism for every token minted, effectively preventing network spam and Sybil attacks.\n\n**2. On-Chain DAO Governance (veAETH)**\nA robust decentralized governance protocol. By staking AETH, users receive veAETH (voting escrow) which grants them voting rights. The DAO Parliament allows the community to propose, discuss, and vote on critical protocol upgrades, fee structures, and treasury allocations, ensuring AetherVault remains fully decentralized and community-driven.",
  ...
  terms: {
    ...
    jurisdiction: "BSC Testnet Decentralized Network",
    backBtn: "Back",
    ...
    sec2Footer: "The protocol operates autonomously on the BSC Testnet blockchain.",
    ...
    sec7Items: [
      ...
      "AetherVault provides a Cryptographic Proof of Existence and time-stamping service. It does not replace formal Intellectual Property (IP) registration with state authorities.",
      "Users are strictly prohibited from utilizing AetherVault's decentralized storage to encrypt or host illegal, terrorist, or explicit materials. As a Zero-Knowledge provider, the developers bear no liability for user-generated ciphertext."
    ],
    ...
    sec9Text1: "AETH is a utility token. It is used for: Minting Capsules, Minting Aether Proof™, Premium storage, Vault Locking, and Governance (future).",
    ...
    sec11Items: ["BSC Network Gas Fee", "Protocol Minting Fee (in AETH)", "Decentralized Storage Fee (where applicable via Arweave/IPFS)"],
    ...
    sec14Text: "Parts of the protocol may be open source. Anyone may audit the contracts. Smart contract addresses are publicly verifiable on the BSC blockchain explorer.",
  ...
  privacy: {
    ...
    sec4Text1: "Because AetherVault is a decentralized Web3 application, your interactions are recorded on the public BSC Testnet blockchain. You must understand that the following metadata is PUBLIC and visible to anyone:",
    ...
    sec7Text1: "AetherVault is open-source-inspired software providing a user interface to decentralized Smart Contracts on BSC Testnet.",
  ...
  roadmap: {
    ...
    phase1Item4: "Vault Reserve Protocol implementation.",
  ...
  dashboard: {
    ...
    consoleStakingFail: "Failed to read vault contract.",
    tiersList: {
    ...
    txStakeTitle: "AETH Locked",
    txStakeDetail: "Tokens successfully locked.",
    txWithdrawTitle: "Vault Unlocked",
    txWithdrawDetail: "Tokens withdrawn from security vault.",
    txRewardClaimTitle: "Allocation Claimed",
    txRewardClaimDetail: "Network allocation successfully claimed.",
    ...
    stakeSuccess: "Successfully locked {amount} AETH.",
    stakeFailPrefix: "Failed to lock: ",
    unstakeExceedsBalance: "Withdrawal amount exceeds balance.",
    unstakeSuccess: "Successfully withdrew {amount} AETH.",
    unstakeFailPrefix: "Failed to withdraw: ",
    noRewardAvailable: "No allocations available.",
    claimRewardSuccess: "Allocation claimed successfully!",
    claimRewardFailPrefix: "Failed to claim allocation: ",
    ...
    secDesc4: "The encryption key is bound to the network (BSC Testnet). Do not use AetherVault on another network.",
    ...
    errInsufficientFunds: "Insufficient tBNB (Gas) or AETH balance for this transaction.",
    ...
    emergencyWarning: "WARNING! Emergency withdrawing before the lock period expires will FORFEIT all allocations accumulated for this deposit. Do you want to proceed?",
    adminTitle: "MASTER ADMIN CONTROL PANEL",
    adminSubtitle: "Full Management of the AetherVault Smart Contract Ecosystem",
    adminAccessDenied: "Access Denied!",
    adminNotOwner: "The currently connected wallet is not the authorized owner of the AetherVault Smart Contract.",
    adminMainEmergency: "1. MAIN TOKEN (AETHERVAULT)",
    adminPauseMain: "Pause Token",
    adminUnpauseMain: "Unpause Token",
    adminStakeEmergency: "2. SECURITY VAULT V6",
    adminPauseStake: "Pause Vault",
    adminUnpauseStake: "Unpause Vault",
    adminVaultEmergency: "3. VAULT V3 & PROOF REGISTRY",
    adminVaultDesc: "Tier configurations, URI placeholders, and secure token recovery are available directly in the main contract.",
    adminPauseVault: "Pause Vault",
    adminUnpauseVault: "Unpause Vault",
    adminChangeTreasury: "Change Treasury Address",
    adminTreasuryPlaceholder: "0x... (New Treasury Wallet)",
    adminUpdateTreasuryBtn: "Update",
    adminVestingTitle: "4. TEAM VESTING (DEVELOPER SALARY)",
    adminVestingDesc: "Release of dev token allocation based on a linear schedule with a 6-month cliff.",
    adminClaimSalaryBtn: "Claim Salary (Vesting)",
    adminChangeBeneficiary: "Change Beneficiary Wallet",
    adminWaitingTimelock: "Waiting for 48-Hour Timelock",
    adminNewTarget: "New Target: ",
    adminExecuteChange: "Execute Wallet Change",
    adminNewWalletPlaceholder: "0x... (New Wallet)",
    adminRequestChangeBtn: "Request Change",
    adminConfirmVestingClaim: "Are you sure you want to claim developer Vesting tokens now?",
    adminFundLabel: "Fund Vault Pool (AETH)",
    adminAmountPlaceholder: "AETH Amount",
    adminFundBtn: "Fund Pool",
    militaryGrade: "Military Grade",
    activeStatus: "Active",
    footerRights: "All rights reserved. Decentralized Protocol V2.2.",
    noTextOnlyImage: "< No text message, image only >",
    encryptedAttachmentDetected: "Encrypted Attachment Detected!",
    processingDecryption: "Processing File Decryption...",
    downloadOriginal: "Download & Open Original File",
    stakingAction: "Vault Action:",
    capsuleIdLabel: "Capsule ID:",
    daoErrForm: "Please complete the proposal form",
    daoTxProposing: "Submitting proposal to DAO Parliament...",
    daoTxProposeSuccess: "Proposal Successfully Submitted to Parliament!",
    daoTxProposeFail: "Failed to create proposal: ",
    daoErrAeth: "Enter a valid AETH amount",
    daoErrVeAeth: "Enter a valid veAETH amount",
    daoTxApproving: "Requesting token approval...",
    daoTxDepositing: "Locking AETH into veAETH Vault...",
    daoTxDepositSuccess: "Successfully minted veAETH & Voting Power!",
    daoTxDepositFail: "Failed to deposit veAETH: ",
    daoTxWithdrawing: "Withdrawing AETH from Vault...",
    daoTxWithdrawSuccess: "AETH Withdrawal Successful!",
    daoTxWithdrawFail: "Failed to withdraw veAETH: ",
    daoTxDelegating: "Activating voting power (Delegating)...",
    daoTxDelegateSuccess: "Voting Power Successfully Activated!",
    daoTxDelegateFail: "Delegation failed: ",
    daoErrPropId: "Enter a valid Proposal ID",
    daoTxVoting: "Casting vote",
    ...
    forgeDesc: "Mint your custom BEP-20 token instantly. Equipped with automated mechanisms (Burn, Vault Allocation, & DAO Treasury).",
    forgeTokenNameLabel: "Token Name",
    forgeTokenNamePlaceholder: "E.g., Aether Meme",
    forgeTokenSymbolLabel: "Token Symbol",
    forgeTokenSymbolPlaceholder: "E.g., AMEME",
    forgeSupplyLabel: "Initial Total Supply",
    forgeSupplyPlaceholder: "E.g., 1000000",
    forgeFeeInfoTitle: "Fee Information:",
    forgeFeeInfoDesc: "Minting a token requires a fee of {fee} AETH, with automatic allocation to maintain protocol economic health.",
    forgeBtnProcessing: "Processing Network...",
    forgeBtnMint: "🚀 Mint Token Now",
    forgeMsgApprove: "Requesting approval (Approve) for {fee} AETH...",
    ...
    faucetWallet: "Wallet Address",
    faucetNotConnected: "Not Connected",
    faucetCooldown: "Cooldown Timer",
    faucetPausedAlert: "Faucet is currently Paused",
    faucetClaimBtn: "Claim {amount} AETH",
    faucetProcessing: "Processing Transaction...",
    faucetCooldownActive: "Cooldown Active",
    faucetGasNote: "*A small amount of tBNB is required to pay for gas fees.",
    faucetErrPaused: "The Faucet is currently paused.",
    faucetErrCooldown: "You are still in the cooldown period!",
    faucetMsgClaiming: "Processing token claim...",
    faucetMsgSuccess: "Success! {amount} AETH has been sent to your wallet.",
    faucetMsgFail: "Failed to claim: ",
    faucetReady: "Ready to Claim",
    adminFaucetBadge: "VIP Faucet",
    adminFaucetTitle: "4. FAUCET V3 CONTROL",
    adminChangeClaim: "Change Claim Amount",
    adminFaucetCurrent: "Current:",
    adminFaucetPlaceholder: "E.g. 5000",
    adminFaucetDistStatus: "Distribution Status:",
    adminFaucetPaused: "PAUSED 🔴",
    adminFaucetActive: "ACTIVE 🟢",
    adminUnpauseFaucet: "Activate Faucet",
    adminPauseFaucet: "Pause Faucet",
    adminMsgUpdatingFaucet: "Updating Faucet claim amount...",
    adminMsgUpdateFaucetSuccess: "Faucet claim amount updated successfully!",
    adminMsgUpdateFaucetFail: "Failed to update Faucet: ",
...
forgeLegalDisclaimerDesc: "AetherVault is a decentralized infrastructure. Developers are not affiliated with, do not control, and bear no liability for the purpose of user-minted tokens, including financial loss or fraud. Do Your Own Research (DYOR)."
  ...
  certModal: {
    ...
    unknown: "Unknown",
    vaultFallback: "Vault",
    legacyVault: "Legacy Vault Capsule",
    timeLockedVault: "Time-Locked Vault Capsule",
    encryptedData: "Encrypted On-Chain Data",
    trustless: "TRUSTLESS • VERIFIED • TIMELESS",
    securedOnChain: "SECURED ON-CHAIN",
    decentralizedRegistry: "Decentralized Vault Registry",
    certAuthenticity: "CERTIFICATE OF AUTHENTICITY",
    cryptoProof: "CRYPTOGRAPHIC PROOF OF OWNERSHIP",
    assetTitle: "ASSET TITLE / TYPE",
    certNo: "CERTIFICATE NO.",
    ownerAddress: "OWNER ADDRESS",
    walletLabel: "WALLET",
    vaultStatus: "VAULT STATUS",
    securedVerified: "● Secured & Verified",
    regDate: "REGISTRATION DATE",
    immutabilityStatement: "CRYPTOGRAPHIC IMMUTABILITY STATEMENT",
    immutabilityDesc: "This artifact asset is permanently secured via end-to-end cryptographic primitives and timestamped on-chain. Molecular ownership records are absolute, immutable, and non-fungible.",
    tokenId: "TOKEN ID",
    networkProt: "NETWORK PROT.",
    smartContract: "SMART CONTRACT",
    securedVault: "SECURED VAULT",
    digitalArtifact: "DIGITAL ARTIFACT",
    aetherVaultProof: "AETHERVAULT PROOF",
    serialReg: "SERIAL REG.",
    autoAuthStatus: "AUTOMATED AUTHENTICITY STATUS",
    verifiableOnChain: "100% VERIFIABLE ON-CHAIN",
    bscVerified: "BSC VERIFIED",
    ...
    preparingPdf: "Preparing PDF file...",
