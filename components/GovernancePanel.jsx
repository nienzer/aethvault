    ...
    <div className="space-y-6">
      ...
      <div className="bg-[#0B0817] border border-cyan-500/30 p-6 sm:p-8 rounded-3xl shadow-xl">
        <div className="flex items-center gap-3 mb-6">
          ...
          <div>
            <h3 className="font-display text-xl font-bold text-white">AetherVault DAO Governance</h3>
            <p className="text-xs text-neutral-400 mt-0.5">Kelola tiket suara veAETH dan tentukan masa depan protokol.</p>
          </div>
        </div>

        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-6">
          <div className="bg-[#05030F] border border-neutral-800 p-5 rounded-2xl">
            <p className="text-[10px] font-mono text-neutral-400 uppercase">Brankas veAETH Anda</p>
          ...
          <div className="bg-[#05030F] border border-neutral-800 p-5 rounded-2xl">
            <p className="text-[10px] font-mono text-neutral-400 uppercase">Kekuatan Suara (Voting Power)</p>
        ...
        <div className="bg-[#05030F] border border-neutral-800 p-5 sm:p-6 rounded-2xl space-y-4">
          <h4 className="text-xs font-bold text-white uppercase tracking-wider font-mono">1. Loket Tiket Suara (Mint / Burn veAETH)</h4>
          <div className="flex flex-col sm:flex-row gap-3">
            ...
            >
              {isVeAethLoading ? <Loader2 className="w-4 h-4 animate-spin mx-auto" /> : "Deposit & Lock AETH"}
            </button>
            <button
              disabled={isVeAethLoading}
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <form onSubmit={handleCreateProposal} className="bg-[#0B0817] border border-neutral-900 p-6 rounded-3xl space-y-4 shadow-xl">
          <h4 className="text-xs font-bold text-white uppercase tracking-wider font-mono flex items-center gap-2">
            <Sparkles className="w-4 h-4 text-cyan-400" /> Buat Proposal Parlemen
          </h4>
          <div className="space-y-3">
            <div>
              <label className="text-[10px] text-neutral-400 font-mono">Target Kontrak (Address)</label>
              <input
                type="text"
                placeholder="0x..."
            ...
            <div>
              <label className="text-[10px] text-neutral-400 font-mono">Deskripsi Proposal</label>
              <textarea
                rows={3}
                placeholder="Contoh: Proposal pembaruan parameter sistem..."
            ...
            >
              {isProposing ? <Loader2 className="w-4 h-4 animate-spin mx-auto" /> : "Kirim Proposal Baru"}
            </button>
          </div>
        </form>
        ...
        <div className="bg-[#0B0817] border border-neutral-900 p-6 rounded-3xl space-y-4 shadow-xl flex flex-col justify-between">
          <div className="space-y-4">
            <h4 className="text-xs font-bold text-white uppercase tracking-wider font-mono flex items-center gap-2">
              <Activity className="w-4 h-4 text-fuchsia-400" /> Voting Panel
            </h4>
            <div>
              <label className="text-[10px] text-neutral-400 font-mono">ID Proposal</label>
              <input
                type="number"
