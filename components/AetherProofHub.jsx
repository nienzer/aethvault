...
// =========================================================
// 🚀 GAYA WEB3 FUTURISTIK: KANVAS DITINGGIKAN (660px) AGAR FOOTER AMAN
// =========================================================
const CertificateTemplate = React.forwardRef(({ proofData, tDash, tHop, formatAddress, categoryConfig, AETHER_LOGO = '/logo.png' }, ref) => {
  ...
  return (
    <div id="cert-export-node" ref={ref} className="w-[890px] h-[660px] bg-[#0A0714] text-gray-200 rounded-2xl p-6 pb-5 relative overflow-hidden font-sans border border-amber-500/30 mx-auto flex flex-col justify-between shrink-0 shadow-[0_0_50px_rgba(139,92,246,0.15)]" style={{ background: 'radial-gradient(ellipse at 20% 0%, #11112d 0%, #090718 42%, #03020a 100%)', borderImage: 'linear-gradient(135deg, #06b6d4, #8b5cf6, #f59e0b, #8b5cf6, #06b6d4) 1', borderWidth: '2px', borderStyle: 'solid' }}>
      ...
      {/* TITLE */}
      <div className="text-center relative z-10 shrink-0 mt-3 mb-3">
      ...
      <div className="flex flex-col gap-4 relative z-10 flex-1 justify-center">
        ...
        <div className="flex gap-4 items-stretch">
          {/* Emblem Kiri */}
          <div className="w-[130px] shrink-0 rounded-2xl border border-violet-500/30 relative overflow-hidden flex items-center justify-center bg-black/30">
            ...
            <img src={AETHER_LOGO} alt="Emblem" className="relative z-10 object-contain drop-shadow-[0_0_20px_rgba(245,158,11,0.65)] av-float" style={{ width: '65px', height: '65px' }} />
          </div>
      ...
      {/* FOOTER */}
      <div className="relative z-10 pt-3 border-t border-neutral-800/60 flex flex-row items-center justify-between px-2 shrink-0 mt-3">
        <div>
